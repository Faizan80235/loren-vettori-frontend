...
import { trackLogin, trackCompleteRegistration } from '../utils/tracking';
...
const Login = () => {
  ...
  const getTrafficSource = () => {
    ...
    console.log('ðŸ” Detecting traffic source...');
    ...
    if (utmSource) {
      console.log('âœ… Campaign detected:', utmSource);
      return {
        source: utmSource,
    ...
    console.log('âœ… Direct traffic detected');
  ...
  const trackActivityInBackend = async (userId, email, activityType) => {
    try {
      ...
      console.log('ðŸ“Š Tracking activity in backend:', {
        userId,
        email,
        activityType,
      ...
      console.log('âœ… Activity tracked in backend database');
    } catch (error) {
      console.error('âŒ Failed to track activity in backend:', error);
      ...
      if (currentState === 'Sign Up') {
        ...
        if (response.data.success) {
          ...
          if (response.data.user) {
            ...
            console.log('âœ… Registration tracked everywhere');
          }
        ...
        try {
          ...
          if (adminResp.data?.success && adminResp.data?.token) {
            ...
            if (adminResp.data.user) {
              ...
              console.log('âœ… Admin login tracked');
            }
        ...
        if (response.data.success) {
          ...
          if (response.data.user) {
            ...
            console.log('âœ… User login tracked everywhere');
          }
